...
class Dishes extends JFrame implements ActionListener{
    ...
    public Dishes(String restourantName, DishItem[] dishItems){
        ...
        ImageIcon topLeftIcon=new ImageIcon(getClass().getResource(dishItems[0].getImagePath()));
        ImageIcon topCenter1Icon= new ImageIcon(getClass().getResource(dishItems[1].getImagePath()));
        ImageIcon topCenter2Icon= new ImageIcon(getClass().getResource(dishItems[2].getImagePath()));
        ImageIcon topRightIcon= new ImageIcon(getClass().getResource(dishItems[3].getImagePath()));
        ImageIcon bottomLeftIcon= new ImageIcon(getClass().getResource(dishItems[4].getImagePath()));
        ImageIcon bottomCenter1Icon= new ImageIcon(getClass().getResource(dishItems[5].getImagePath()));
        ImageIcon bottomCenter2Icon= new ImageIcon(getClass().getResource(dishItems[6].getImagePath()));
        ImageIcon bottomRightcon= new ImageIcon(getClass().getResource(dishItems[7].getImagePath()));
     ...
     restaurantItem[] restaurantItems={
            ...
            new restaurantItem("backArrowIcon", "images/backArrow.png")
        };
